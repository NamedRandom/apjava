...
public class PalindromeLab {
  public static void main(String[] args) {
    ...
    }; // changeArrayToPalindrome(String [] arr);
  ...
  public static String reverse(String str) {
    ...
    String out = "";
    for (int i = str.length() - 1; i >= 0; i--) out = out + str.charAt(i);
    return out;
  }
  ...
  public static String changeToPalindrome(String str) {
    ...
    if (str == "") return "";
    if (str.length() % 2 == 0)
      return str.substring(0, str.length() / 2) + reverse(str).substring(str.length() / 2);
